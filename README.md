...
Statistical Analysis of consumer data, in order to visualize the findings based on <br> consumer demographics, behavior, media campaign response, and purchase, <br>
